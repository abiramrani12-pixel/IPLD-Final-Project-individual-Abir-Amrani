...
unique_countries_list = sorted(temps_df["City"].unique().tolist())
...
min_row = temps_df.loc[temps_df["AvgTemperatureCelsius"].idxmin()]
max_row = temps_df.loc[temps_df["AvgTemperatureCelsius"].idxmax()]
